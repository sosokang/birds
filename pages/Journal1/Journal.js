...
Page({
      ...
      wx.request({
        ...
        success: function (result) {
          if (result.data.code != 0) {
            ...
            wx.request({
              url: 'https://xcxu.birdfans.com/source/xcxbirdapi/article/index.php?cmd=articleCommentList',
              data: {
                uid: wx.getStorageSync('uid'),
                aid: that.data.tid,
              },
    ...
    wx.request({
      ...
      success: function (result) {
        ...
        that.setData({
          ...
          authorHead: result.data.data.head,
          authorid: result.data.data.authorid,
          title: result.data.data.title,
          postBody: result.data.data.articleList,
          publishTime: result.data.data.dateline,
          ...
          vfrom: result.data.data.from,
        })
        // console.log(that.data.images)
      }
    })
    wx.request({
      url: 'https://xcxu.birdfans.com/source/xcxbirdapi/article/index.php?cmd=articleUpList',
      data: {
        uid: wx.getStorageSync('uid'),
        aid: that.data.tid,
      },
  ...
  onShareAppMessage: function () {
    return {
      title: '爱鸟国际',
      path: 'pages/Journal1/Journal?aid=' + this.data.tid + '&fanhui=1',
    }
  }
})